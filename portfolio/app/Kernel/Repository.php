...
abstract class Repository
{
	...
	public function __construct(Connection $db, Array $repository = array()) {
		...
		$this->objectName = str_replace('Repository', 'Model', substr(get_class($this),0,-10));
		$this->tableName = str_replace('Repository', 'Model', str_replace('\\','_',substr(get_class($this),0,-10)));
	}
	 ...
	 *
	 * @param \Portfolio\Domain\Model\Object $object The entity to save
	 */
	 ...
	 *
	 * @param \Portfolio\Domain\Model\Article $article The article to remove
	 */
