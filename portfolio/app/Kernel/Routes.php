...
$app->match('/admin/article/delete/{id}', 'articleController:deleteAction')->bind('deleteArticle');
...
$app->match('/admin/bio/delete/{id}', 'bioController:deleteAction')->bind('deleteBio');
...
$app->match('/admin/diploma/delete/{id}', 'diplomaController:deleteAction')->bind('deleteDiploma');
...
$app->match('/admin/exp/delete/{id}', 'expController:deleteAction')->bind('deleteExp');
...
$app->match('/admin/skill/delete/{id}', 'skillController:deleteAction')->bind('deleteSkill');
...
$app->match('/admin/interest/delete/{id}', 'interestController:deleteAction')->bind('deleteInterest');
...
$app->match('/admin/contact/delete/{id}', 'contactController:deleteAction')->bind('deleteContact');
...
$app->match('/admin/user/delete/{id}', 'userController:deleteAction')->bind('deleteUser');
